...
def plot_baselines():
    ...
    trapavoiding_reward_arrays = [np.load(f'{c.DATA_DIR}trapavoiding_source_None_accumulated_rmr_a2c_residual_lamb_{1}.npy'),
                                  np.load(f'{c.DATA_DIR}trapavoiding_source_pathfinding_accumulated_rmr_a2c_residual_lamb_{1}.npy')]
    ...
    trapavoiding_legends_array = ['No Transfer with \lambda=1.0',
